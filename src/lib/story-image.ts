 ...
 */
const BLOCKED =
  /(?:^|\.)patch\.com$|patch\.com|patchcdn|patch-?(?:am|logo)|logo|sprite|favicon|default[-_]?(?:image|thumb)|avatar|blank\.|1x1|spacer|watermark|header[-_]?ad|\/ads\/|\/advert|\/adserver|doubleclick|consent\.yahoo\.com|yahoo_frontpage/i;
