...
const TITLE = "Bay Area Community People — Foundation Icons | Times Bay Area";
const DESC =
  "Community leaders, pioneers and achievers recognised by Times Bay Area.";
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10">
      ...
      <p className="mt-3 text-[17px] leading-relaxed text-foreground">
        Times Bay Area recognises the people who built and who represent the Bay Area Indian
